...
use Illuminate\Http\Request;
    ...
    Route::post('/user/profile-image',[UserController::class,'addProfileImage']);
    Route::patch('/password/reset-in-profile',[PasswordResetController::class,'editPasswordInProfile']);
    //post
